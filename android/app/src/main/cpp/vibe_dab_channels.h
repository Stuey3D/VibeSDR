...
/** Band III, the whole plan, IN ASCENDING FREQUENCY ORDER (nearestChannel and stepChannel both
 *  depend on that, and a test asserts it).
 *
 *  ★ The UK uses 11A-12D for national and local multiplexes; the rest are here because a receiver
 *    that only knows its own country's subset is wrong the moment somebody runs it elsewhere, and
 *    the table costs nothing.
 *  ★★ THE "N" BLOCKS ARE REAL AND ARE EASY TO MISS. 10N (210.096), 11N (217.088) and 12N
 *     (224.096) are offset blocks squeezed between the lettered ones — I left them out of the
 *     first draft and Stuart's own block list caught it. They sort BETWEEN their neighbours
 *     (11A -> 11N -> 11B), so stepping through the band reaches them in frequency order rather
 *     than skipping a multiplex that is genuinely on air. */
inline constexpr Channel kBandIII[] = {
    ...
    {"10A", 209936000}, {"10N", 210096000}, {"10B", 211648000}, {"10C", 213360000},
    {"10D", 215072000},
    {"11A", 216928000}, {"11N", 217088000}, {"11B", 218640000}, {"11C", 220352000},
    {"11D", 222064000},
    {"12A", 223936000}, {"12N", 224096000}, {"12B", 225648000}, {"12C", 227360000},
    {"12D", 229072000},
