...
//    Ported from src/services/countryLookup.ts (the phone uses full polygons; grouping needs only bbox).
enum CountryBBox {
  ...
  /// Smallest bbox containing the point wins (small countries beat the big overlapping ones).
  ...
  /// 🇺🇸 flag emoji from an ISO alpha-2 code.
