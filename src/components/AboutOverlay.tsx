...
const VERSION_HISTORY: { v: string; detail: string }[] = [
  ...
  { v: 'V10.3.1', detail: 'Audio could go silent on connecting \u2014 fixed. A change in 10.3 made the start of playback a race with itself, so on some connections the app set the audio path up and then immediately tore it down again: a perfect signal, a moving data meter and no sound, on any server, and often fine on the next attempt. If it happens again the app now says so in its own log rather than failing quietly.' },
