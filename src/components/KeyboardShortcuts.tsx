...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'For everything else, hold Shift with an arrow, and Alt/Option with Tab in place of Tab. Full Keyboard Access claims only the plain navigation keys and leaves modified ones alone, so these always get through. It is one key with two names: an Apple keyboard labels it Option, a Windows one labels it Alt, and both arrive here as the same thing. Avoid Command, which the system keeps for switching apps.',
